...
#define digit4 GPIOD,GPIO_PIN_3
#define digit3 GPIOD,GPIO_PIN_2
#define digit2 GPIOA,GPIO_PIN_2
#define digit1 GPIOA,GPIO_PIN_1
...
int main( void )
{
 ...
 while(1)
 {
  for(i = 0; i<=9999; i++)
  {
   for(j=0;j<=50;j++)
   {
     GPIO_WriteHigh(digit1);
     LED7_writeByte(led7Hex[i%10]);
     delay(10);
     GPIO_WriteLow(digit1);
     
     GPIO_WriteHigh(digit2);
     LED7_writeByte(led7Hex[i/10%10]);
     delay(10);
     GPIO_WriteLow(digit2);
     
     GPIO_WriteHigh(digit3);
     LED7_writeByte(led7Hex[i/100%10]);
     delay(10);
     GPIO_WriteLow(digit3);
     
     GPIO_WriteHigh(digit4);
     LED7_writeByte(led7Hex[i/1000]);
     delay(10);
     GPIO_WriteLow(digit4);
   }
  }
 } 
}